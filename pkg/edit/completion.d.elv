...
# A function for custom command name completion. It receives the seed (the
# partial command name being completed) and should output candidates. If not
# set, the built-in command completion is used.
